...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/avr128da48-phase-sequence-detection-of-ac-supply-studio.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/avr128da48-phase-sequence-detection-of-ac-supply-studio.git'
