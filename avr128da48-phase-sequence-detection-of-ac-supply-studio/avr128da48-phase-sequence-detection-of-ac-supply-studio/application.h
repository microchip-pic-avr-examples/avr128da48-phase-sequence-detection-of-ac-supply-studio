...
#define WAVEFORM_CONSTANT  268435456.0f    //equation constant 
	...
	#define ADC_OFFSET_VALUE 2100              //Practically generated singal is not exactly 3.3V its considered as below 3.3 so (4000 - 2000 = 2000 +/- 100)
#else
	#define ADC_STEPS_PER_VOLTAGE 0.0016113f    
	#define ADC_OFFSET_VALUE 1050             //this is for differential ended adc  
#endif
